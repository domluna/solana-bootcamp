...
declare_id!("GZV8j5GDppEMGg3xdHK98cwsuqQri8aWB7dBT8zdV758");
...
impl Beats for Hand {
    fn beats(&self, other: Self) -> bool {
        match (*self, other) {
            ...
            (Hand::Rock, Hand::Lizard) => true,
            (Hand::Paper, Hand::Rock) => true,
            (Hand::Paper, Hand::Spock) => true,
            (Hand::Scissors, Hand::Paper) => true,
            (Hand::Scissors, Hand::Lizard) => true,
            (Hand::Lizard, Hand::Spock) => true,
            (Hand::Lizard, Hand::Paper) => true,
            (Hand::Spock, Hand::Scissors) => true,
            (Hand::Spock, Hand::Rock) => true,
            _ => false,
        }
    }
}
...
impl Game {
    ...
    pub fn pick_winner(&mut self) -> HandResult {
        let player1 = self.hand[0].beats(self.hand[1]);
        let player2 = self.hand[1].beats(self.hand[0]);
